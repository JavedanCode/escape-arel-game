...
public class KeyHandler implements KeyListener {
    ...
    public boolean upPressed, downPressed, leftPressed, rightPressed,enterPressed,shiftPressed,shootKeyPressed,spacePressed,taskWindowActive;
    ...
    public void titleState(int code){
            ...
            if(code == KeyEvent.VK_ENTER) {
                ...
                if(gp.ui.commandNum == 0){
                    ...
                    gp.tManager.taskNum = gp.tManager.taskGotoUni;
    ...
    public void playState(int code){
            ...
            if(code == KeyEvent.VK_Q) {
                taskWindowActive = !taskWindowActive;
            }
